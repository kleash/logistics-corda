...
public class NodeDriver {
    public static void main(String[] args) {
        ...
        driver(new DriverParameters().withWaitForAllNodesToFinish(true).withExtraCordappPackagesToScan(Arrays.asList("com.nec.endmile")),dsl -> {
                    List<CordaFuture<NodeHandle>> nodeFutures = ImmutableList.of(
                            dsl.startNode(new NodeParameters()
                                    .withProvidedName(new CordaX500Name("Amazon", "London", "GB"))
                            ...
                            dsl.startNode(new NodeParameters()
                                    .withProvidedName(new CordaX500Name("NECAuto", "New York", "US"))
