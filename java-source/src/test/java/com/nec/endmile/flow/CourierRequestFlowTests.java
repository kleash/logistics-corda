...
public class CourierRequestFlowTests {
    ...
    public void setup() {
        ...
        a = network.createPartyNode(new CordaX500Name("Amazon", "London", "GB"));
        b = network.createPartyNode(new CordaX500Name("NECAuto", "New York", "US"));
 ...
 /*   @Test
    ...
    public void flowRecordsATransactionInBothPartiesTransactionStorages() throws Exception {
        CourierRequestFlow.Initiator flow = new CourierRequestFlow.Initiator(10, 10, 10, 10, "krpuram", "marathahalli", b.getInfo().getLegalIdentities().get(0));
        CordaFuture<SignedTransaction> future = a.startFlow(flow);
        network.runNetwork();
        SignedTransaction signedTx = future.get();
