...
public class ExampleFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            responses.put("partner1", "response1 - response2");
            responses.put("partner2", "response3 - response4");

            IOUState iouState = new IOUState(iouValue, me, otherParty, new UniqueIdentifier(), responses);
